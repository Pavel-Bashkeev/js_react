...
const cart = {
	...
	getTotalPrice: function () { return this.totalPrice },
	...
	calculateItemPrice: function () {
		this.totalPrice = this.items.reduce((allTotal, item) => allTotal + item.price * item.amount, 0);
...
cart.add('Товар 1', 300);
cart.add('Товар 2', 150, 2);
cart.add('Товар 3', 450, 3);
